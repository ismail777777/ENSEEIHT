...
let rec fusionne ordre l1 l2 =
  match l1,l2 with
    |[],_ -> l2
    |_,[] -> l1
    |(t::q1),(e::q2)-> if ordre t e then t::(fusionne ordre q1 l2) else e::(fusionne ordre l1 q2)
...
*)
 let listStat = 
  let input = open_in "/home/ielalout/Desktop/n7/2A/PF/sourceEtu_tp2/sourceEtu/nat2016.txt" in 
...
*)
 let listStatHomme = 
  let input = open_in "/home/ielalout/Desktop/n7/2A/PF/sourceEtu_tp2/sourceEtu/nathomme2016.txt" in
  let filebuf = Lexing.from_channel input in
  Parser.main Lexer.token filebuf 
