...
(******************************************************************************)
let appartient mot (Trie(a,decomp,recomp)) = appartient_arbre (decomp(mot)) a
...
(******************************************************************************)
let retrait mot (Trie(abr, decomp, recomp)) = Trie(retrait_arbre (decomp(mot)) abr, decomp, recomp)
...
(******************************************************************************)
let trie_dico (Trie(arbre, decomp, recomp)) =
  List.map(fun l -> recomp l) (parcours arbre)
(******************************************************************************)
...
(*   résultat   : aucun                                                       *)
(******************************************************************************)
let affiche p (Trie(arbre, decomp, recomp)) = 
  List.iter p (trie_dico (Trie(arbre, decomp, recomp)))