...
module PrExemples = Exemples(Print)
let%test _ = (PrExemples.exemple = "let x = 1+2 in (x*3)")
let%test _ = (PrExemples.exemple1 = "1+(2*3)") 
let%test _ = (PrExemples.exemple2 = "(5+2)*(2*3)")