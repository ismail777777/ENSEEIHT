...
/* import */
import : /* Lambda, mot vide */ { (print_endline "import : /* Lambda, mot vide */"); }
		| IMPORT import { (print_endline "import : IMPORT import"); }
...
fichier : programme FIN { (print_endline "fichier : programme FIN");(print_string "Nombre de fonctions : ");(print_int !nbrFonctions);(print_newline()) }
		| import programme FIN { (print_endline "fichier : programme FIN");(print_string "Nombre de fonctions : ");(print_int !nbrFonctions);(print_newline()) }
...
instructions : instruction_b { (print_endline "instructions : instructions");
			                (print_string "Nombre d'instructions : ");
							(print_int $1);
							(print_newline());
							}
...
instruction : expression PTVIRG { (print_endline "instruction : expression PTVIRG") }
			| SI PAROUV expression PARFER bloc { (print_endline "instruction : SI PAROUV expression PARFER corps") }
			| SI PAROUV expression PARFER bloc SINON bloc { (print_endline "instruction : SI PAROUV expression PARFER corps SINON corps") }
			| TANTQUE PAROUV expression PARFER bloc { (print_endline "instruction : TANTQUE PAROUV expression PARFER corps") }
            | RETOUR expression PTVIRG  { (print_endline "instruction : RETURN expression PTVIRG") }

instruction_b : /* Lambda, mot vide */ { (print_endline "instruction_b : /* Lambda, mot vide */"); 0 }
				| instruction instruction_b { (print_endline "instruction_b : instruction"); $2+1}
