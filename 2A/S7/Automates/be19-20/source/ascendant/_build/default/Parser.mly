...
programme : regle UL_FIN { (print_endline "programme : regle suite_regle FIN ") }
...
deduction : predicat UL_DEDUCTION suite_deduction UL_PT { (print_endline "deduction : predicat UL_DEDUCTION suite_deduction UL_PT") }
...
suite_variable : UL_VARIABLE UL_VIRG suite_variable { (print_endline "suite_variable : variable UL_VIRG suite_variable") }
                ...
                | UL_VARIABLE { (print_endline "suite_variable : UL_VARIABLE") }
