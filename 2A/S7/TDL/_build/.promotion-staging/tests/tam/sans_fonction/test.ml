open Rat
open Compilateur
let () = Filename.set_temp_dir_name("/home/ielalout/Desktop/n7/2A/TDL/TP2-6/sourceEtu/temp")
...
let%expect_test "testIfOpt" =
  runtam (pathFichiersRat^"testIfOpt.rat");
  [%expect{|  |}]

let%expect_test "testIfOpt2" =
  runtam (pathFichiersRat^"testIfOpt2.rat");
  [%expect{| 18 |}]

let%expect_test "testLoop" =
  runtam (pathFichiersRat^"testLoop.rat");
  [%expect{| 66tam.TamException: Tam error : Program has failed due to overflow. |}]